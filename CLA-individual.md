# Maker Individual Contributor License Agreement

Thank you for your interest in contributing to Maker ("We" or "Us").

This contributor agreement ("Agreement") documents the rights granted
by contributors to Us. To make this document effective, please submit
a pull request with a file under the `/contributors` directory
indicating your acceptance of this agreement, following the
instructions at
https://gitlab.com/crankykernel/maker/blob/master/CONTRIBUTING.md.
...
Contribution: (including any right to adopt any future version of a
...
https://gitlab.com/crankykernel/maker/blob/master/CONTRIBUTING.md, if
...
with the laws of Canada excluding its conflicts of law
